...
let
  cfg = config.networking.networkmanager-small;
...
in {
  ...
  options = {
    ...
    networking.networkmanager-small = {
  ...
  config = mkIf cfg.enable {
    ...
    assertions = [{
      ...
      message = "You can not use networking.networkmanager-small at the same time as networking.networkmanager";
    }];
